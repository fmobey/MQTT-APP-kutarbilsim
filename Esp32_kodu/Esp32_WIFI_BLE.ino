...
void wifiTask() {
  ...
  if(receivedData.length() > 0){
    ...
    String ip = getValue(receivedData, ',', 2);
    String dns1 = getValue(receivedData, ',', 3);
    String dns2 = getValue(receivedData, ',', 4);
    String subnet = getValue(receivedData, ',', 5);
    ...
    WiFi.config(ip.toInt(), dns1.toInt(), dns2.toInt(), subnet.toInt());
    
   //  WiFi.setDNS(dns1.toInt(),dns2.toInt());
